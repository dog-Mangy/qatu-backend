    ...
    public class QatuDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                // Tech Store
                new Product { Id = product1Id, Image="https://i.ibb.co/xtbmB42y/W-O-X500-Global-4-G-LTE-6-5-Inch-Quad-Core-Big-Battery-Play-Store-Support-Android-Smartphone.jpg", StoreId = store1Id, Name = "Smartphone", Description = "Latest model smartphone", CategoryId = electronicsCategoryId, Price = 699.99m, Rating = 4.5m, Stock = 50, CreatedAt = DateTime.UtcNow },
                new Product { Id = product2Id, Image="https://i.ibb.co/x8BXFDqV/laptop.jpg", StoreId = store1Id, Name = "Laptop", Description = "High-performance laptop", CategoryId = electronicsCategoryId, Price = 1299.99m, Rating = 4.8m, Stock = 20, CreatedAt = DateTime.UtcNow },
                new Product { Id = Guid.NewGuid(), Image="https://i.ibb.co/B2BpfVrx/huawei-matepad-11-5-s-grey.jpg", StoreId = store1Id, Name = "Tablet", Description = "Lightweight and portable", CategoryId = electronicsCategoryId, Price = 499.99m, Rating = 4.3m, Stock = 30, CreatedAt = DateTime.UtcNow },
                new Product { Id = Guid.NewGuid(), Image="https://i.ibb.co/fGrpbQMJ/smartwatch.jpg", StoreId = store1Id, Name = "Smartwatch", Description = "Fitness tracker", CategoryId = electronicsCategoryId, Price = 199.99m, Rating = 4.1m, Stock = 40, CreatedAt = DateTime.UtcNow },
                new Product { Id = new Guid("30a8c927-9774-4057-9f6a-2c4158d2b2d3"), Image="https://i.ibb.co/4R8qDKD2/hheadphones.jpg", StoreId = store1Id, Name = "Headphones", Description = "Noise-canceling headphones", CategoryId = electronicsCategoryId, Price = 149.99m, Rating = 4.4m, Stock = 25, CreatedAt = DateTime.UtcNow },

                // Fashion
                new Product { Id = new Guid("377f3896-ed4d-4e68-ad30-02cc65e426b8"), Image="https://i.ibb.co/0RZTny2w/jeans.jpg", StoreId = store2Id, Name = "Jeans", Description = "Blue denim jeans", CategoryId = clothingCategoryId, Price = 49.99m, Rating = 4.2m, Stock = 100, CreatedAt = DateTime.UtcNow },
                new Product { Id = new Guid("45726569-0a33-4ed1-9ce3-072324033594"), Image="https://i.ibb.co/XZCpMr3Z/tshirt.jpg", StoreId = store2Id, Name = "T-Shirt", Description = "100% Cotton T-shirt", CategoryId = clothingCategoryId, Price = 19.99m, Rating = 4.0m, Stock = 150, CreatedAt = DateTime.UtcNow },
                new Product { Id = new Guid("73e0fe7b-530b-4cc1-9ad0-a028f116b0a8"), Image="https://i.ibb.co/9HjpFWPM/jacket.jpg", StoreId = store2Id, Name = "Jacket", Description = "Waterproof winter jacket", CategoryId = clothingCategoryId, Price = 99.99m, Rating = 4.3m, Stock = 60, CreatedAt = DateTime.UtcNow },
                new Product { Id = new Guid("7a44753c-aa8c-480f-ade8-bcf20ab8a6ce"), Image="https://i.ibb.co/k2vTgq3j/sneakers.png", StoreId = store2Id, Name = "Sneakers", Description = "Comfortable sneakers", CategoryId = clothingCategoryId, Price = 59.99m, Rating = 4.2m, Stock = 120, CreatedAt = DateTime.UtcNow },

                // Home
                new Product { Id = new Guid("81461fab-579e-4b88-8406-8c66890f59a3"), Image ="https://i.ibb.co/ksVP0spL/sofa.jpg", StoreId = store3Id, Name = "Sofa", Description = "Modern 3-seater sofa", CategoryId = furnitureCategoryId, Price = 899.99m, Rating = 4.6m, Stock = 10, CreatedAt = DateTime.UtcNow },
                new Product { Id = Guid.NewGuid(), Image="https://i.ibb.co/hxhd6GTZ/0403037-dallas-ranch-rustic-solid-wood-double-pedestal-dining-table-set.jpg", StoreId = store3Id, Name = "Dining Table", Description = "Solid wood dining table", CategoryId = furnitureCategoryId, Price = 499.99m, Rating = 4.5m, Stock = 15, CreatedAt = DateTime.UtcNow },
                new Product { Id = Guid.NewGuid(), Image="https://i.ibb.co/84xwsfWB/bed.jpg", StoreId = store3Id, Name = "Bed Frame", Description = "Queen size bed frame", CategoryId = furnitureCategoryId, Price = 299.99m, Rating = 4.7m, Stock = 5, CreatedAt = DateTime.UtcNow },
                new Product { Id = Guid.NewGuid(), Image="https://i.ibb.co/bMHCSV6p/led.png", StoreId = store3Id, Name = "Lamp", Description = "LED floor lamp", CategoryId = furnitureCategoryId, Price = 49.99m, Rating = 4.2m, Stock = 30, CreatedAt = DateTime.UtcNow },
                new Product { Id = Guid.NewGuid(), Image="https://i.ibb.co/SWjnYY1/81-Ry-C8-YEst-L-AC-SL1500.jpg", StoreId = store3Id, Name = "Carpet", Description = "Soft area rug", CategoryId = furnitureCategoryId, Price = 99.99m, Rating = 4.3m, Stock = 20, CreatedAt = DateTime.UtcNow }
            );
